      ...
      >
        ...
        >
          ...
          >
            ...
            /{" "}
            <Link to="/members" style={{ color: "#6B7280", textDecoration: "none" }}>
              Members
            </Link>
          </Typography>
          <Typography
          ...
          >
            Manage who can access this business. Invite new users and assign roles
          </Typography>
          ...
          >
            {/* Email Field */}
            <Box sx={{ flex: 1 }}>
              <Typography variant="body2" sx={{ color: "#1F2937", mb: 0.5, fontSize: { xs: "11px", sm: "12px" } }}>
                Email
              </Typography>
              <TextField
            ...
            <Box sx={{ flex: 1 }}>
              <Typography variant="body2" sx={{ color: "#1F2937", mb: 0.5, fontSize: { xs: "11px", sm: "12px" } }}>
                Assign to Team <span style={{ color: "#6B7280" }}>(optional)</span>
              </Typography>
              <TextField
                select
                variant="outlined"
                    ...
                    <CardContent sx={{ p: 2 }}>
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
                        <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                          <Typography sx={{ fontSize: "12px", color: "#6B7280" }}>Role:</Typography>
                          <Box
                            sx={{
                          ...
                          <Box sx={{ display: "flex", gap: 1 }}>
                            <Tooltip title="Change Role">
                              <IconButton size="small">
                                <Person sx={{ color: "#3B82F6", fontSize: "18px" }} />
                              </IconButton>
                            </Tooltip>
                            ...
                            <Tooltip title="Resend Invite">
                              <IconButton size="small">
                                <Replay sx={{ color: "#22C55E", fontSize: "18px" }} />
                              </IconButton>
                            </Tooltip>
                          </Box>
                        </Box>
                      ...
                      <TableRow key={index}>
                        ...
                        <TableCell sx={{ borderBottom: "1px solid #E5E7EB" }}>
                          <Box sx={{ display: "flex", gap: { sm: 0.5, md: 1 } }}>
                            <Tooltip title="Change Role">
                              <IconButton size="small">
                                <Person sx={{ color: "#3B82F6", fontSize: { sm: "18px", md: "20px" } }} />
                              </IconButton>
                            </Tooltip>
                            <Tooltip title="Remove">
                              <IconButton size="small">
                                <Delete sx={{ color: "#EF4444", fontSize: { sm: "18px", md: "20px" } }} />
                              </IconButton>
                            </Tooltip>
                            <Tooltip title="Resend Invite">
                              <IconButton size="small">
                                <Replay sx={{ color: "#22C55E", fontSize: { sm: "18px", md: "20px" } }} />
                              </IconButton>
                            </Tooltip>
                          </Box>
                        </TableCell>
