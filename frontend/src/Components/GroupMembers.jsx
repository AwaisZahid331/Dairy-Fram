...
const teams = [
  {
    ...
    description: "Lorem ipsum dolor sit amet consectetur. Ut fringilla amet risus vel mollis molestie sed pharetra. In nunc nec adipiscing.",
    members: [
...
const GroupMembers = () => {
  ...
  const handleDeleteMember = (memberToDelete) => {
    setSelectedMembers(selectedMembers.filter((member) => member !== memberToDelete));
  };
  ...
  return (
    <Box sx={{ display: "flex", height: "100vh", overflow: "hidden" }}>
      ...
      <Box
        sx={{
          marginLeft: { xs: "50px", sm: "60px", md: "80px" },
      ...
      >
        ...
        >
          ...
          >
            ...
            /{" "}
            <Link to="/groupmembers" style={{ color: "#6B7280", textDecoration: "none" }}>
              Teams
            </Link>
          </Typography>
            ...
            >
              ...
              >
                ...
                <IconButton onClick={handleClose}>
                  <Close sx={{ color: "black", fontSize: { xs: "20px", sm: "24px" } }} />
                </IconButton>
              </Box>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: { xs: 1.5, sm: 2 } }}>
                        ...
                        <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
                          {selected.map((value) => (
                            <Chip
                              ...
                              deleteIcon={<Cancel sx={{ color: "black !important", fontSize: { xs: "14px", sm: "16px" } }} />}
                              sx={{
                ...
                <Box>
                  ...
                  <FormControl fullWidth>
                    ...
                    >
                      <MenuItem value="">
                        <em style={{ color: "black", fontSize: { xs: "12px", sm: "14px" } }}>
                          -Select-
                        </em>
                      </MenuItem>
          ...
          <Box>
                  ...
                  <CardContent sx={{ p: 2 }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
                      <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                        <Typography sx={{ fontSize: "12px", color: "#6B7280" }}>Members:</Typography>
                        <Box>
                      ...
                      <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                        <Typography sx={{ fontSize: "12px", color: "#6B7280" }}>Projects:</Typography>
                        <Typography sx={{ fontSize: "12px", color: "#1F2937" }}>
                          {team.projects}
                        </Typography>
                      </Box>
                      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mt: 1 }}>
                        <Typography sx={{ fontSize: "12px", color: "#6B7280" }}>Actions:</Typography>
                        <Box sx={{ display: "flex", gap: 0.5 }}>
                          <IconButton size="small">
                            <Visibility sx={{ color: "#6B7280", fontSize: "18px" }} />
                          </IconButton>
                          <IconButton size="small">
                            <Edit sx={{ color: "#6B7280", fontSize: "18px" }} />
                          </IconButton>
                          <IconButton size="small">
                            <Delete sx={{ color: "#6B7280", fontSize: "18px" }} />
                          </IconButton>
                        </Box>
                      </Box>
                    </Box>
            ...
            >
              <Table>
                ...
                <TableBody>
                  {teams.map((team, index) => (
                    <TableRow key={index} sx={{ height: { sm: "70px", md: "80px" } }}>
                      {/* Name */}
                      <TableCell
                        sx={{
                          fontSize: { sm: "12px", md: "14px" },
                          ...
                          <AvatarGroup max={4}>
                            {team.members.map((member, idx) => (
                              <Avatar
                                key={idx}
                                src={member}
                                sx={{ width: { sm: "28px", md: "32px" }, height: { sm: "28px", md: "32px" } }}
                              />
                            ))}
                          </AvatarGroup>
                        ) : (
                          <Typography sx={{ color: "#6B7280", fontSize: { sm: "12px", md: "14px" } }}>
                            No Members
                          </Typography>
                        )}
                      </TableCell>
                      ...
                      <TableCell sx={{ borderBottom: "1px solid #E5E7EB" }}>
                        <Box sx={{ display: "flex", gap: { sm: 0.5, md: 1 } }}>
                          <IconButton size="small">
                            <Visibility sx={{ color: "#6B7280", fontSize: { sm: "18px", md: "20px" } }} />
                          </IconButton>
                          <IconButton size="small">
                            <Edit sx={{ color: "#6B7280", fontSize: { sm: "18px", md: "20px" } }} />
                          </IconButton>
                          <IconButton size="small">
                            <Delete sx={{ color: "#6B7280", fontSize: { sm: "18px", md: "20px" } }} />
                          </IconButton>
                        </Box>
                      </TableCell>
                    </TableRow>
